...
const IMAGE_MAP: Record<string, string> = {
  ...
  'role-public-user': '/images/role-public-user.png',
  'role-farm-admin': '/images/role-farm-admin.png',
  'role-twge-admin': '/images/role-twge-admin.png',
  'meditation-public-donor': '/images/meditation-public-donor.png',
  'meditation-presence-verify': '/images/meditation-presence-verify.png',
  'meditation-group-session': '/images/meditation-group-session.png',
  'wallet-display': '/images/wallet-display.png',
  'credits-earning': '/images/credits-earning.png',
  'streak-bonus': '/images/streak-bonus.png',
  'transaction-qr-scan': '/images/transaction-qr-scan.png',
  'transaction-peer-transfer': '/images/transaction-peer-transfer.png',
  'vendor-redemption-request': '/images/vendor-redemption-request.png',
  'donor-subscription': '/images/donor-subscription.png',
  'donor-receiving-love': '/images/donor-receiving-love.png',
  'donor-impact-view': '/images/donor-impact-view.png',
  'community-goal-education': '/images/community-goal-education.png',
  'community-goal-water': '/images/community-goal-water.png',
  'community-goal-food': '/images/community-goal-food.png',
  'project-progress': '/images/project-progress.png',
  'energy-community-power': '/images/energy-community-power.png',
  'energy-dashboard': '/images/energy-dashboard.png',
  'energy-charging-station': '/images/energy-charging-station.png',
  'wellbeing-checkin': '/images/wellbeing-checkin.png',
  'miracle-story': '/images/miracle-story.png',
  'inspiration-feed': '/images/inspiration-feed.png',
  'global-love-counter': '/images/global-love-counter.png',
  'total-meditation-hours': '/images/total-meditation-hours.png',
  'community-network': '/images/community-network.png',
  'onboarding-welcome': '/images/onboarding-welcome.png',
  'onboarding-choose-role': '/images/onboarding-choose-role.png',
  'local-verification': '/images/local-verification.png',
